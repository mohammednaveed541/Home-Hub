document.addEventListener('DOMContentLoaded', () => {
  ...
  const propertiesContainer = document.getElementById('rent-properties');
    ...
    fetch('js/utils.js')
      ...
      .then(text => {
        ...
        if (match && match[1]) {
          ...
          let properties = sampleProperties.filter(p => p.listingType === 'rent');
          
          if (properties.length === 0) {
            propertiesContainer.innerHTML = '<div class="no-results">No rental properties found</div>';
            return;
          }
          ...
          properties.forEach(property => {
            ...
            // This is a simplified version for the rent page
            const priceDisplay = `$${property.price}/month`;
            ...
            propertiesHTML += `
              <div class="property-card">
                <div class="property-image" style="background-image: url('${property.image}')">
                  <div class="property-type property-rent">
                    For Rent
                  </div>
                </div>
      ...
      fetch('js/utils.js')
        ...
        .then(text => {
          ...
          if (match && match[1]) {
            ...
            // Filter for rent properties
            let filteredProperties = sampleProperties.filter(p => p.listingType === 'rent');
